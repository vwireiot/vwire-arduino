 ...
 * - Automatic GPIO pin control from cloud (enabled by default)
 * - Syncing stored pin values on connect
 *
 * Dashboard Setup:
 * - V0: Button/Switch widget (controls built-in LED)
 * - D2/D4/D5: Add pins in Device Settings → GPIO Configuration,
 *   then control with Button/Slider widgets
 * 
 * Instructions:
...
void setup() {
  ...
  // TLS and GPIO pin management are enabled by default
